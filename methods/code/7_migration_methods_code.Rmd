...
- 10\% of HHs received remittances in last 5 years $\rightarrow$ many long-ago emigrants
...
ggplot(table, aes(x=index_rank5, y=avg_index_rank)) +
  geom_point() +
  geom_vline(xintercept = 1234.5, linetype = "solid", color = "red") +
  geom_hline(yintercept = 1234.5, linetype = "solid", color = "red")
```
...
The answer is similar using either the weighted or unweighted distribution
